...
#
# Usage:
#   bash scripts/run_seeds.sh scripts/train_ingpo_tree_MATH.sh
#   SEEDS="0 1 2 3 4" bash scripts/run_seeds.sh scripts/train_ingpo_tree_GSM8K.sh
...
[[ -x "${INNER}" ]] || INNER="${INGPO_ROOT}/${INNER}"
