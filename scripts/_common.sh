...
ensure_runtime_config() {
  ...
  if [[ -n "${INGPO_ALGORITHM_MODE:-}" ]]; then
    ingpo_inference_overrides+="      ingpo_algorithm_mode: '${INGPO_ALGORITHM_MODE}',"$'\n'
  fi
  ...
  if [[ -n "${INGPO_N_MIN:-}" ]]; then
    ingpo_inference_overrides+="      ingpo_n_min: ${INGPO_N_MIN},"$'\n'
  fi
