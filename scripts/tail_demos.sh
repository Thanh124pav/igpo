#!/usr/bin/env bash
# Tail the human-readable InGPO demos file in a running experiment.
# Usage:
#   bash scripts/tail_demos.sh <exp_name>
#   bash scripts/tail_demos.sh <exp_name> jsonl     # raw JSONL stream
#
# Resolves to ${APP_DIRECTORY:-experiments}/<exp>/ingpo_demos/demos.{md,jsonl}.
...
DEMOS_DIR="${APP_DIRECTORY}/${EXP}/ingpo_demos"
case "${KIND}" in
