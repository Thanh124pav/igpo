...
// final values come out the way the caller chained them.
{
  episode_generator+: {
    ...
    inference_strategy+: {
      ...
      ingpo_score_timeout_seconds: $.ingpo.score_timeout_seconds,
      ingpo_score_retry_attempts: $.ingpo.score_retry_attempts,
      ...
      ingpo_n_tv_estimates: $.ingpo.n_tv_estimates,
      ingpo_tv_subnode_max_tokens: $.ingpo.tv_subnode_max_tokens,
      ingpo_tv_second_phase_tokens: $.ingpo.tv_second_phase_tokens,
