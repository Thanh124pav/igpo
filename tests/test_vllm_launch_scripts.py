...
def test_positional_launcher_defaults_empty_dtype_to_auto(tmp_path):
    ...
    assert _dtype_arg(args) == "auto"


def test_named_launcher_defaults_empty_dtype_to_auto(tmp_path):
    args = _run_with_fake_python(
        tmp_path,
